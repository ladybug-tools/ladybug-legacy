...
========================================
Check the group here: http://www.grasshopper3d.com/group/ladybug
There is also a facebook page: https://www.facebook.com/LadyBugforGrasshopper
...
----------------------------
	...
	1.  Download Ladybug:
		...
		Download the unlocked version here: (https://www.box.com/s/02d7kp230vb045i9j4ix)
		Download the locked version here: (https://www.box.com/s/azhlbgakvvrdgvhcciiy)
		The password is: “whatever” (without quotation marks)

	2.	Installation:
		
		There is no installation! After you download the files just drag and drop the files into Grasshopper canvas. You should then see the Ladybug tab in Grasshopper.
	...
	3.	Check the sample file and watch the videos:
		If you haven’t watched it yet, watch the video here.
		It shows what Ladybug does; more videos are available on my channel. I will, periodically, capture and upload more videos.
		There is also a sample file that you can download from here.
...
----------------------------
	...
	2.	Spread the word: Let more people know about Ladybug. Like it on Facebook(https://www.facebook.com/LadyBugforGrasshopper) or follow it on Twitter (https://twitter.com/ladybug_tool).
	
	3.	Donate the project:  [I will provide a link later!]

I know Python. Does it make any difference?
----------------------------
	Yes! It does. You can be part of Ladybug development and make a big difference! Simply fork Ladybug repository from here, or use the unlocked components, develop your own components or modify the available components and share it back to the community. 
