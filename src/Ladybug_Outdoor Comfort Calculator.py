...
if _runIt == True:
    universalThermalClimateIndex, comfortableOrNot, conditionOfPerson, percentOfTimeComfortable, percentComfForShortPeriod, percentHeatStress, percentColdStress = main()
