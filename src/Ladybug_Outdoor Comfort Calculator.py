...
_
A UTCI between -13 and 9 degrees Celcius indicates slight cold stress (comfortable for short periods of time). Between -13 and -27 degrees, UTCI indicates strong cold stress (not at all comfortable and dangerous beyond short periods of time).  Below -27, UTCI indicates very stong to extreme cold stress (very dangerous).
_
_
...
Provided by Ladybug 0.0.58
    ...
    Returns:
        ...
        conditionOfPerson: A stream of interger values from -2 to +2 that indicate the following:
                       -2 - Strong Cold Stress - the mortality rate is higher than normal (UTCI < -13 C).
                       -1 - Slight/Moderate Cold Stress - cool but comfortable for short periods of time (-13 < UTCI <9).
                       0  - No Thermal Stress  - comfortable conditions (9 < UTCI < 26).
                       +1 - Slight/Moderate Heat Stress - warm but comfortable for short periods of time (26 < UTCI < 32).
                       +2 - Strong Heat Stress - the mortality rate is higher than normal (UTCI > 32 C).
        ------------------------------: ...
