...
Provided by Ladybug 0.0.69
    ...
    Args:
        ...
        windSpeed_tenMeters_: A number representing the wind speed of the air in meters per second at 10 meters off the ground (note that nearly all wind readings for EPW data are 10m off the ground).  If no value is plugged in here, this component will assume a low wind speed of 0.5 m/s, which is the lowest input speed that is recommended for the UTCI model.  This input can also accept a list of wind speeds representing conditions at different times or the direct output of windSpeed from of the Import EPW component.
