    ...
    if sc.sticky.has_key('ladybug_release'):
        ...
        if checkData == True and calcComfortRange_ == True:
            try:
                ...
                upperComfortTemperature = []
                lowerComfortTemperature = []
                print "The comfort range calculation has been terminated by the user!  The initial calculation of PMV, PPD and SET finished and has been output."
                e = gh.GH_RuntimeMessageLevel.Warning
                ghenv.Component.AddRuntimeMessage(e, "The comfort range calculation has been terminated by the user!  The initial calculation of PMV, PPD and SET finished and has been output.")
